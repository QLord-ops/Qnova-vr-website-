...
const translations = {
  en: {
    ...
    vrGamingSession: "VR Gaming Session (30 minutes)", psVRExperience: "PlayStation VR Experience (30 minutes)", groupVRParty: "Group VR Party (30 minutes)",
    ...
    pricingTitle: "Pricing & Packages", pricingDescription: "Choose the perfect VR gaming package for your needs. All sessions include equipment rental and expert guidance.",
    individualVR: "Individual VR Session", individualVRDesc: "Perfect for first-time VR users or solo gaming adventures.",
    individualVRPrice: "€25", individualVRDuration: "30 minutes", individualVRFeatures: ["Latest VR headset", "Game selection", "Expert guidance"],
    groupVR: "Group VR Session", groupVRDesc: "Ideal for friends and family gaming together.",
    groupVRPrice: "€20", groupVRDuration: "30 minutes per person", groupVRFeatures: ["Up to 4 players", "Multiplayer games", "Group discounts"],
    playstationSession: "PlayStation Gaming", playstationSessionDesc: "Experience the latest PlayStation 5 games in comfort.",
    playstationPrice: "€15", playstationDuration: "1 hour", playstationFeatures: ["PlayStation 5 console", "Latest games", "Comfortable seating"],
    vrPartyPackage: "VR Party Package", vrPartyPackageDesc: "Perfect for birthdays, celebrations, and special events.",
  ...
  de: {
    ...
    individualVR: "Einzelne VR-Session", individualVRDesc: "Perfekt für VR-Erstnutzer oder Solo-Gaming-Abenteuer.",
    individualVRPrice: "€25", individualVRDuration: "30 Minuten", 
    groupVR: "Gruppen VR-Session", groupVRDesc: "Ideal für Freunde und Familie, die zusammen spielen.",
    groupVRPrice: "€20", groupVRDuration: "30 Minuten pro Person", 
    playstationSession: "PlayStation Gaming", playstationSessionDesc: "Erleben Sie die neuesten PlayStation 5-Spiele bequem.",
    playstationPrice: "€15", playstationDuration: "1 Stunde", 
  ...
  ru: {
    ...
    bookingTitle: "Забронировать сеанс", bookingDescription: "Забронируйте свой 30-минутный VR или PlayStation игровой сеанс. Выберите дату, время и услугу по вашему желанию.",
    ...
    individualVR: "Индивидуальная VR-сессия", individualVRDesc: "Идеально для новичков в VR или сольных игровых приключений.",
    individualVRPrice: "€25", individualVRDuration: "30 минут", 
    groupVR: "Групповая VR-сессия", groupVRDesc: "Идеально для друзей и семьи, играющих вместе.",
    groupVRPrice: "€20", groupVRDuration: "30 минут на человека", 
    playstationSession: "PlayStation Gaming", playstationSessionDesc: "Испытайте новейшие игры PlayStation 5 с комфортом.",
    playstationPrice: "€15", playstationDuration: "1 час", 
